...
<head>
    ...
    <title>SEM II | UPLOAD QUESTION PAPERS</title>
...
<body>
    ...
    mysqli_query($db, "INSERT INTO sem_two_que (file, description) VALUES ('$name', '$description')");

    $result = mysqli_query($db, "SELECT file, description FROM sem_two_que ORDER BY id asc" ) or die("SELECT Error: ".mysql_error()); 
