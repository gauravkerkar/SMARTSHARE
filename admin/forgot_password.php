<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $id = $_POST['userid'];
        $name = $_POST['username'];
        $query = mysqli_query($db, "SELECT * FROM admin WHERE id='$id' && email='$email' && username='$name'") or die(mysqli_error($db));
    ...
    $mail->Body = "Hii Admin your password is {$row['password']}";
                ...
                <div class="d-flex justify-content-center form_container">
                    <form method="POST">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" name="userid" class="form-control input_pass" placeholder="User id"
                                required>
                        </div>
                        <div class="input-group mb-2">
                            <div class="input-group-append">
                            ...
                            <input type="text" name="username" class="form-control input_pass" placeholder="Username"
                                required>
                        </div>
                        <div class="input-group mb-2">
                            <div class="input-group-append">
                            ...
                            <input type="email" name="email" class="form-control input_pass" placeholder="Email address"
                                required>
                        </div>
