...
<head>
    ...
    <title>SEM IV | UPLOAD NOTES</title>
...
<body>
    ...
    mysqli_query($db, "INSERT INTO sem_four_notes (file, description) VALUES ('$name', '$description')");

    $result = mysqli_query($db, "SELECT file, description FROM sem_four_notes ORDER BY id asc" ) or die("SELECT Error: ".mysqli_error()); 
