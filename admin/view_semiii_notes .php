...
<head>
    ...
    <title>SEM III | VIEW NOTES</title>
...
<div class="container">
        <table class="table table-bordered table-striped table-hover table-light">
                ...
                <tbody>
                        ...
                        $query = "SELECT * FROM sem_three_notes";
                        ...
                        <tr>
                            ...
                            if(isset($_GET["id"]))  {
                                $id = $_GET['id'];
                                $sql = "DELETE FROM sem_three_notes WHERE id='$id'";
                                mysqli_query($db, $sql);
                                }
                            ?>
                            <a href="view_semiii_notes.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Delete</a>
                            </td>
                        </tr>
                        <?php
                }
