...
<head>
    ...
    <title>SEM III | UPLOAD QUESTION PAPERS</title>
...
<body>
    ...
    mysqli_query($db, "INSERT INTO sem_three_que (file, description) VALUES ('$name', '$description')");

    $result = mysqli_query($db, "SELECT file, description FROM sem_three_que ORDER BY id asc" ) or die("SELECT Error: ".mysql_error()); 
