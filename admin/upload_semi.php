...
<body>
    ...
    <div class="sem">
        ...
        <div class="row">
        <div class="col-sm-4">
            <a class="btn btn-primary" style="width:9em; height:8.4em; margin-bottom: 12px; margin-top: 12px; border-top:3px solid honeydew;border-left: 3px solid honeydew;" href="upload_semi_notes.php">
                <div>
        ...
        <div class="col-sm-4">
            <a class="btn btn-primary" style="width:9em; height:8.4em; margin-bottom: 12px; margin-top: 12px; border-top:3px solid honeydew;border-left: 3px solid honeydew;" href="upload_semi_timetbl.php">
                <img width="90" src="../img/timetable.png">
                <div class="text-white">Time Table</div>
            </a>
        </div>
        <div class="col-sm-4">
            <a class="btn btn-primary" style="width:9em; height:8.4em; margin-bottom: 12px; margin-top: 12px; border-top:3px solid honeydew;border-left: 3px solid honeydew;" href="upload_semi_que.php">
