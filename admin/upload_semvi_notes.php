...
<head>
    ...
    <title>SEM VI | UPLOAD NOTES</title>
...
<body>
    ...
    mysqli_query($db, "INSERT INTO sem_six_notes (file, description) VALUES ('$name', '$description')");

    $result = mysqli_query($db, "SELECT file, description FROM sem_six_notes ORDER BY id asc" ) or die("SELECT Error: ".mysqli_error()); 
