...
<head>
    ...
    <title>SEM VI | UPLOAD TIMETABLE</title>
...
<body>
    ...
    mysqli_query($db, "INSERT INTO sem_six_timetbl (file, description) VALUES ('$name', '$description')");

    $result = mysqli_query($db, "SELECT file, description FROM sem_six_timetbl ORDER BY id asc" ) or die("SELECT Error: ".mysql_error()); 
