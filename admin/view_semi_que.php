...
<head>
    ...
    <title>SEM I | VIEW QUESTION PAPERS</title>
        ...
        <table class="table table-bordered table-striped table-hover table-light">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            if(isset($_GET["id"]))  {
                                $id = $_GET['id'];
                                $sql = "DELETE FROM sem_one_que WHERE id='$id'";
                                mysqli_query($db, $sql);
                                }
                            ?>
                            <a href="view_semi_que.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Delete</a>
                            </td>
                        </tr>
                        <?php
                }
