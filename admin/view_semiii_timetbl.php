...
<head>
    ...
    <title>SEM III | VIEW TIMETABLE</title>
...
<div class="container">
        <table class="table table-bordered table-striped table-hover table-light">
                ...
                <tbody>
                        ...
                        $query = "SELECT * FROM sem_three_timetbl";
                        ...
                        <tr>
                            ...
                            if(isset($_GET["id"]))  {
                                $id = $_GET['id'];
                                $sql = "DELETE FROM sem_three_timetbl WHERE id='$id'";
                                mysqli_query($db, $sql);
                                }
                            ?>
                            <a href="view_semiii_timetbl.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Delete</a>
                            </td>
                        </tr>
                        <?php
                }
