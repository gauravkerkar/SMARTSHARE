...
<head>
    ...
    <title>SEM II | UPLOAD NOTES</title>
...
<body>
    ...
    mysqli_query($db, "INSERT INTO sem_two_notes (file, description) VALUES ('$name', '$description')");

    $result = mysqli_query($db, "SELECT file, description FROM sem_two_notes ORDER BY id asc" ) or die("SELECT Error: ".mysqli_error()); 
