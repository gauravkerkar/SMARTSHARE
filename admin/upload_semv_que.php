...
<head>
    ...
    <title>SEM V | UPLOAD QUESTION PAPERS</title>
...
<body>
    ...
    mysqli_query($db, "INSERT INTO sem_five_que (file, description) VALUES ('$name', '$description')");

    $result = mysqli_query($db, "SELECT file, description FROM sem_five_que ORDER BY id asc" ) or die("SELECT Error: ".mysql_error()); 
