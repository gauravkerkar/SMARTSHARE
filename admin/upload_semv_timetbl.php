...
<head>
    ...
    <title>SEM V | UPLOAD TIMETABLE</title>
...
<body>
    ...
    mysqli_query($db, "INSERT INTO sem_five_timetbl (file, description) VALUES ('$name', '$description')");

    $result = mysqli_query($db, "SELECT file, description FROM sem_five_timetbl ORDER BY id asc" ) or die("SELECT Error: ".mysql_error()); 
