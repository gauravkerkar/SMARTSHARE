...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2019 at 07:13 AM
...
-- Database: `maxyum`
--
CREATE DATABASE IF NOT EXISTS `maxyum` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `maxyum`;
...
(1, 'ROAST BREAKFAST', 400),
(2, 'SEAFOOD STEW', 400),
(3, 'SMOKED CHICKEN CROQUETTE', 300),
(4, 'JERK CHICKEN SANDWICH', 320),
(5, 'PULLED PORK BURGER', 320),
(6, 'SEAFOOD RISOTTO', 420),
(7, 'HUEVOS RANCHEROS', 350),
(8, 'SLOW ROASTED FRIED CHICKEN', 480),
(9, 'CROQUE MONSIEUR', 350),
(10, 'CHOCOLATE NUTELLA TART', 280),
(11, 'BANANA PANCAKES', 320),
(12, 'S\'MORES CUSTARD CAKE', 270),
(13, 'ROASTED ICE TEA', 120),
(14, 'PINK LEMONADE', 120),
(15, 'FRESH ORANGE JUICE', 120),
(16, 'CHOCOLATE SHAKE', 190),
(17, 'AVOCADO MANGO CHIA', 220),
(18, 'MINERAL WATER', 40);
...
(5, 'Admin', 'admin@gmail.com', 2147483647, 'Panaji-Goa', 'admin', '21232f297a57a5a743894a0e4a801fc3');
...
('root', '2019-03-13 06:04:33', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":0}');
